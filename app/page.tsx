  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      ...
      <section className="relative py-16 text-center sm:py-24">
        <div className="pointer-events-none absolute inset-0 -z-10 flex justify-center opacity-30" aria-hidden="true">
        ...
        <span className="chip mb-6 inline-flex">
          <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-bull" aria-hidden="true" />
        ...
        <h1 className="mx-auto max-w-3xl text-4xl font-extrabold tracking-tight text-white sm:text-6xl">
          Understand any trading chart in <span className="text-accent">seconds</span>
        </h1>
      ...
      <section className="grid gap-5 pb-16 md:grid-cols-3">
        {FEATURES.map((f) => (
          <div key={f.title} className="card p-6 transition hover:border-accent/30">
      ...
      <section className="pb-20">
        ...
        <div className="card mx-auto mt-8 max-w-4xl border-amber-300/20 bg-amber-300/[0.04] p-5">
          <p className="text-center text-xs leading-relaxed text-amber-100/80">
